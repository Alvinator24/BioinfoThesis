...
load("C:/Users/Roooiz/Desktop/Thesis Preprocessing/tryingInfiniumPurify/gene_level_methylation__TSS1500-TSS200__Both.rda")
...
write.csv(gene_level_df,
          "C:/Users/Roooiz/Desktop/Thesis Preprocessing/tryingInfiniumPurify/gene_level_methylation.csv",
          row.names = FALSE)

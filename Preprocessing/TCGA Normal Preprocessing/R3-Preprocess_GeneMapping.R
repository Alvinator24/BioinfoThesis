...
setwd("C:/Users/Roooiz/Desktop/Thesis Preprocessing/TCGA-Assembler")
...
beta_clean <- fread(
  "C:/Users/Roooiz/Desktop/Thesis Preprocessing/filtered_imputed_data.csv",
  data.table = FALSE
)
...
result <- CalculateSingleValueMethylationData(
  ...
  outputFileFolder = "C:/Users/Roooiz/Desktop/Thesis Preprocessing"
)
